...
export const scenes: Record<Checkpoint, SceneDefinition> = {
  village: {
    title: "새벽바람 마을",
    objective: "마을을 둘러보고 동쪽 길로 나가 보자.",
    ground: "village",
    width: 1200,
    height: 800,
    spawn: { x: 250, y: 560 },
  ...
  world: {
    title: "바람결 초원",
    objective: "숲과 초원을 가로질러 마을, 동굴, 성으로 이어진 길을 찾아보자.",
    ground: "grass",
    width: 1800,
    height: 1200,
    spawn: { x: 90, y: 600 },
    ...
    exits: [
      ...
      { rect: { x: 410, y: 30, width: 150, height: 45 }, to: "dungeon", spawn: { x: 1100, y: 1440 }, label: "메아리 동굴" },
      { rect: { x: 1480, y: 28, width: 190, height: 48 }, to: "castle-1", spawn: { x: 750, y: 970 }, label: "검은 성", requiresLevel: 3, requiresGreatSword: true },
      { rect: { x: 1768, y: 970, width: 32, height: 150 }, to: "secret", spawn: { x: 85, y: 450 }, label: "이름 없는 숲", hidden: true },
    ],
  },
  dungeon: {
    title: "메아리 동굴",
    objective: "굽이치는 동굴을 탐색하며 마물과 맞서자.",
    ground: "dungeon",
    width: 2200,
    height: 1600,
    spawn: { x: 1100, y: 1440 },
    obstacles: dungeonWalls,
    exits: [{ rect: { x: 1030, y: 1490, width: 140, height: 110 }, to: "world", spawn: { x: 485, y: 125 }, label: "초원으로" }],
  },
  "castle-1": {
    title: "검은 성 · 1층",
    objective: "무너진 대연회장을 지나 위층 계단을 찾아가자.",
    ground: "castle",
    width: 1500,
    height: 1100,
    spawn: { x: 750, y: 970 },
    ...
    exits: [
      { rect: { x: 650, y: 1010, width: 200, height: 90 }, to: "world", spawn: { x: 1575, y: 130 }, label: "성 밖" },
      { rect: { x: 650, y: 0, width: 200, height: 55 }, to: "castle-2", spawn: { x: 750, y: 970 }, label: "2층 계단" },
    ],
  },
  "castle-2": {
    title: "검은 성 · 2층",
    objective: "긴 회랑을 돌파해 왕좌의 방으로 향하자.",
    ground: "castle",
    width: 1500,
    height: 1100,
    spawn: { x: 750, y: 970 },
  ...
  boss: {
    title: "왕좌의 방",
    objective: "성주 모르가스를 쓰러뜨리고 봉인된 문을 열자.",
    ground: "castle",
    width: 1300,
    height: 900,
    spawn: { x: 650, y: 760 },
  ...
  secret: {
    title: "이름 없는 숲",
    objective: "숲 가장 깊은 곳에서 희미한 문자의 기척이 느껴진다.",
    ground: "secret",
    width: 1200,
    height: 900,
    spawn: { x: 85, y: 450 },
    ...
    title: "별빛 탑",
    objective: "고요한 탑 끝에서 누군가 기다리고 있다.",
    ground: "rescue",
    width: 1000,
    height: 700,
    spawn: { x: 250, y: 470 },
