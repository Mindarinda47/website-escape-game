...
export function SportsPage() {
  ...
  function finishMatch() {
    ...
    notify(predictionWasCorrect ? "예측 성공 보상으로 5만원권을 획득했습니다." : "예측이 빗나가 보상은 지급되지 않았습니다.");
  }
  ...
  return (
    <main className="sports-page page-inner">
      ...
      <section className="match-hero">
        <div className="team home-team"><span className="team-crest">G</span><h2>강림FC</h2><small>HOME</small></div>
        ...
        <div className="team away-team"><span className="team-crest">D</span><h2>도림FC</h2><small>AWAY</small></div>
