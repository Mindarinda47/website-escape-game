...
export const adventureText = {
  ...
  npc: {
    ...
    fortuneTeller: {
      name: "점술가 할머니",
      intro: "허허, 길을 잃었느냐? 점괘 하나의 복채는 15G란다. 같은 걸 다시 물어도 복채는 다시 받지.",
      insufficientGold: "복채가 모자라구나. 15G를 마련해 다시 오너라.",
      menuGuide: "방향키로 고르고 E를 누르거나, 원하는 질문을 클릭하거라.",
      close: "대화 끝내기",
      options: [
        { label: "첫 번째 알파벳", answer: "바람결 초원의 남동쪽 끝에는 눈에 잘 띄지 않는 길이 있단다. 그 너머 숲의 악기를 찾아보거라." },
        { label: "두 번째 알파벳", answer: "쇼핑에는 숨겨진 상품이 있단다. 페이지 안에서 '라스트'를 정확히 찾아보거라." },
        { label: "세 번째 알파벳", answer: "승부를 맞히고 나면 주소에 유난히 튀는 대문자가 보일 게야. 주소 그 자체를 눌러 보거라." },
        { label: "네 번째 알파벳", answer: "쇼핑 상점의 카드 상품을 자세히 들여다보거라. 크게 보아야만 드러나는 것도 있는 법이지." },
        { label: "다섯 번째 알파벳", answer: "칠흑 성의 주인을 쓰러뜨린 뒤 공주와 끝까지 이야기를 나누거라." },
        { label: "여섯 번째 알파벳", answer: "산불 기사의 불을 끈 뒤에는, 칠흑같은 밤으로 바꾸어 사진을 다시 살펴보거라." },
        { label: "정답 입력 장소", answer: "모든 문자를 알맞게 늘어놓았다면, 처음 마주한 GOGLE 포털의 검색창에 그 말을 입력하거라." },
      ],
    },
